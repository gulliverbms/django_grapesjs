...
class ApplyRenderTag(object):
    ...
    def apply_tag_init(self, string):
        """
        This method applies the render tag (render all the code inside it as Django template) during template init
        """
    ...
    def apply_tag_save(self, string):
        """
        This method applies the render tag during saving template to the database
        """
        return string
